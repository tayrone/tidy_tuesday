...
rating_genre %>% 
  ...
  labs(title = "Most netflix titles are TV shows rated for adults and 14+ year olds",
       subtitle = "Which are represented ad TV-MA and TV-14, respectively",
       x = "Rating", y = "Genre", size = "")
